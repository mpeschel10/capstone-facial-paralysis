...
export function response303Login(user_id, username, kind) {
    const status = 303;
    const Location = kind === "ADMIN" ? "/dashboard" : "/home";
    const headers = {Location, "Set-Cookie": makeLoginCookie(user_id, username, kind)};
